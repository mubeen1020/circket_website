  ...
  $("#dialog-confirmBall").dialog({
        ...
        buttons: {
          "Delete Ball": function() {
            ...
            var matchId = '3319';
            var ajaxUrl = '' + ballId + '&matchId=' + matchId;
            $.ajax({
              url:ajaxUrl,
  ...
  $("#dialogUpdateVideoLink").dialog({
        ...
        buttons: {
          ...
          $("#update_youtube_link").val();
            ...
            var ajaxUrl = '' + update_video_ballId;
            var hostname = '';
            var ajaxUrl = hostname
  ...
  <script type="text/javascript">
      function drawChart() {
        var data = google.visualization.arrayToDataTable([
          ['Over', '',{type: 'string', role: 'tooltip', 'p': {'html': true}},
          ...
          ,[1,7,'<strong>: 7/0 (1.0 Overs)</strong>',8,'<strong>Royal Tigers: 8/0 (1.0 Overs)</strong>',null,null,null,null]
          
          
          ,[2,13,'<strong>: 13/0 (2.0 Overs)</strong>',14,'<strong>Royal Tigers: 14/0 (2.0 Overs)</strong>',null,null,null,null]
          
          
          ,[3,15,'<strong>: 15/0 (3.0 Overs)</strong>',20,'<strong>Royal Tigers: 20/0 (3.0 Overs)</strong>',null,null,null,null]
          
          
          ,[4,19,'<strong>: 19/0 (4.0 Overs)</strong>',38,'<strong>Royal Tigers: 38/0 (4.0 Overs)</strong>',null,null,null,null]
          
          
          ,[5,26,'<strong>: 26/0 (5.0 Overs)</strong>',49,'<strong>Royal Tigers: 49/0 (5.0 Overs)</strong>',null,null,null,null]
          
          
          ,[6,38,'<strong>: 38/0 (6.0 Overs)</strong>',58,'<strong>Royal Tigers: 58/1 (6.0 Overs)</strong>',null,null,null,null]
          
              ,[6,38,'<strong>: 38/0 (6.0 Overs)</strong>',58,'<strong>Royal Tigers: 58/1 (6.0 Overs)</strong>',null,null,1,'5.2 Usman A to Mubashir J <strong>STUMPED</strong><BR><strong>Mubashir Jawed</strong> St Atanu B b Usman A 20 (18b  1 Fours, 1 Sixers SR 111.11)']
              
          
          ,[7,50,'<strong>: 50/1 (7.0 Overs)</strong>',66,'<strong>Royal Tigers: 66/1 (7.0 Overs)</strong>',null,null,null,null]
          
          ,[7,50,'<strong>: 50/1 (7.0 Overs)</strong>',66,'<strong>Royal Tigers: 66/1 (7.0 Overs)</strong>',1,'6.4 Muhammad Salman A to Usman A1 runs <strong>RUN OUT</strong><BR><strong>Usman Aziz</strong> run out (Muhammad Salman A)  13 (15b  0 Fours, 1 Sixers SR 86.67)',null,null]
          
          
          ,[8,57,'<strong>: 57/1 (8.0 Overs)</strong>',77,'<strong>Royal Tigers: 77/1 (8.0 Overs)</strong>',null,null,null,null]
          
          
          ,[9,66,'<strong>: 66/1 (9.0 Overs)</strong>',82,'<strong>Royal Tigers: 82/1 (9.0 Overs)</strong>',null,null,null,null]
          
          
          ,[10,78,'<strong>: 78/1 (10.0 Overs)</strong>',93,'<strong>Royal Tigers: 93/1 (10.0 Overs)</strong>',null,null,null,null]
          
          
          ,[11,83,'<strong>: 83/2 (11.0 Overs)</strong>',null,'<strong>Royal Tigers: null/1 (11.0 Overs)</strong>',null,null,null,null]
          
          ,[11,83,'<strong>: 83/2 (11.0 Overs)</strong>',null,'<strong>Royal Tigers: null/1 (11.0 Overs)</strong>',1,'10.4 Irfan S to Atanu B <strong>BOWLED</strong><BR><strong>Atanu Bharali</strong> b Irfan S 49 (41b  2 Fours, 1 Sixers SR 119.51)',null,null]
          
          
          ,[12,91,'<strong>: 91/2 (12.0 Overs)</strong>',null,'<strong>Royal Tigers: null/1 (12.0 Overs)</strong>',null,null,null,null]
