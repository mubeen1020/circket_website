			...
			<div class="complete-list">
				<div class="panel with-nav-tabs panel-default">
                    ...
                    <div id="tablePlayerRankings_wrapper" class="dataTables_wrapper no-footer">
						...
						<th class="spa sorting" tabindex="0" aria-controls="tableBowlingRecords" rowspan="1" colspan="1" aria-label="Overs: activate to sort column ascending" style="width: 41px;"><a href="#" class="sortheader" onclick="ts_resortTable(this, 5);return false;">Fielding <p><a href="#"><i class="fa-solid fa-arrow-down-short-wide"></i></a></p></a></th>
