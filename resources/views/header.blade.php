                    ...
                    <div id="mobile-header" class="row" style="margin-right: -150px;">
                        <div class="col-sm-4 col-xs-12">
                            <div class="logo">
                                <table>
                                    <tr>
                                        <td style='width:100px;height:100px;'><a href="MississaugaCricketLeague.html"><img src="{{ asset('utilsv2/img/others/eoscl-logo.png') }}" border="0" style='width:100px;height:100px;' class="img-responsive center-block img-circle" /></a>

                                        </td>
                                        <td style="padding-left:8px;">
                                            <a href="MississaugaCricketLeague.html" style="text-decoration: none; display: inline-block;">
